...
bucket = storage_client.bucket("sid-ml-ops-polyinfo")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "udemy-mlops-429815.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://sid-ml-ops-polyinfo/bank_campaign_data/bank-additional.csv"
    model_name='xgboost'
